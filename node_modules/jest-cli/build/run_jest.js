...
function _load_failed_tests_cache() {return _failed_tests_cache = _interopRequireDefault(require('./failed_tests_cache'));}var _jest_hooks;
...
const getTestPaths = (() => {var _ref = _asyncToGenerator(function* (
  ...
  jestHooks)
  {
    ...
    data.tests.map(function (test) {return jestHooks.shouldRunTestSuite(test.path);}));


    const filteredTests = data.tests.filter(function (test, i) {return shouldTestArray[i];});
...
const testSchedulerContext = {
  firstRun: true,
  previousSuccess: true };exports.default = (() => {var _ref3 = _asyncToGenerator(
  ...
  {let contexts = _ref2.contexts,globalConfig = _ref2.globalConfig,outputStream = _ref2.outputStream,testWatcher = _ref2.testWatcher;var _ref2$jestHooks = _ref2.jestHooks;let jestHooks = _ref2$jestHooks === undefined ? new (_jest_hooks || _load_jest_hooks()).default().getEmitter() : _ref2$jestHooks,startRun = _ref2.startRun,changedFilesPromise = _ref2.changedFilesPromise,onComplete = _ref2.onComplete,failedTestsCache = _ref2.failedTestsCache;
    ...
    const results = yield new (_test_scheduler || _load_test_scheduler()).default(
    globalConfig,
    {
      startRun },
  ...
  });function runJest(_x6) {return _ref3.apply(this, arguments);}return runJest;})();