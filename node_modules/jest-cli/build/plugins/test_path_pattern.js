...
function _load_watch_plugin() {return _watch_plugin = _interopRequireDefault(require('../watch_plugin'));}var _test_path_pattern_prompt;
function _load_test_path_pattern_prompt() {return _test_path_pattern_prompt = _interopRequireDefault(require('../test_path_pattern_prompt'));}var _active_filters_message;
...
class TestPathPatternPlugin extends (_watch_plugin || _load_watch_plugin()).default {
  ...
  updateConfigAndRun)
  {
    return new Promise((res, rej) => {
      const testPathPatternPrompt = new (_test_path_pattern_prompt || _load_test_path_pattern_prompt()).default(
      this._stdout,
      this._prompt);
