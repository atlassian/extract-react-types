...
class JestHooks {
  ...
  getEmitter() {var _this = this;
    return {
      shouldRunTestSuite: (() => {var _ref = _asyncToGenerator(function* (testPath) {return (
            Promise.all(
            _this._listeners.shouldRunTestSuite.map(function (listener) {return (
                listener(testPath));})).

            then(function (result) {return (
                result.every(function (shouldRunTestSuite) {return shouldRunTestSuite;}));}));});return function shouldRunTestSuite(_x) {return _ref.apply(this, arguments);};})(),
